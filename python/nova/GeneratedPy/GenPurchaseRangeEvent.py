...
class GenPurchaseRangeEvent(PurchaseEvent):
	...
	def construct(self, game, executionTime, player, cost, delta):
		# Construct the PurchaseRangeEvent with all the required attributes that do not have default values
		self.setGame( game )
