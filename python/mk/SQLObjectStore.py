...
class SQLObjectStore(ObjectStore):
	...
	def close(self):
		if self._connection is not None:
			self.closeConnection(self._connection)
			self._connection = None

	def closeConnection(self, connection):
		""
		Should be implemented to close the database connection
		""
	...
	# keg: refreshAttrs is false by default
	def fetchObjectsOfClass(self, aClass, clauses='', isDeep=1, refreshAttrs=0, serialNum=None):
		"""
